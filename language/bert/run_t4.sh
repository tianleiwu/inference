...
mv results/fast_${QTYPE}_batch_${BATCH}/ results_b${BATCH}_$2/results/T4/bert/
mv build/compliance_output/fast_${QTYPE}_batch_${BATCH}/ results_b${BATCH}_$2/compliance/T4/bert/